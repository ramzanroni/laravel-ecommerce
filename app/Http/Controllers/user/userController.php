...
//    for quntity control in cart ENDS
    ...
    public function profile(Request $request, $id)
    {
         ...
         $cat = Category::all();
         $useraddress = DB::table('addresses')->where('id', '=',  $id)->get();
    
    return view('store.profile_manage')
    ->with('userinfo', $userinfo)
    ->with("cat", $cat)
    ->with('add', $useraddress)
        ;
    }
    ...
    return view('store.update_profile')
    ->with('userinfo', $userdata)
    ->with("cat", $cat)
    ->with('add', $useraddress);
    }
