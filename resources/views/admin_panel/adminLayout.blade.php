...
<head>
    ...
    <title>Manage Shop Admin Panel</title>
    <!-- plugins:css -->
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
                <a class="navbar-brand brand-logo" href="{{route('admin.dashboard')}}">
                    <div style="color: #ffea2d;">Manage Shop</div>
                </a>
                <a class="navbar-brand brand-logo-mini" href="{{route('admin.dashboard')}}">
                    <div style="color: #fffb00;">Manage Shop</div>
                </a>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-center bg-warning">
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown d-none d-xl-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            <br>
                            <br>
                            <a class="dropdown-item bg-danger" href="{{route('admin.logout')}}">
                                Sign Out
                            </a>
                        </div>
                    </li>
